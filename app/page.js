              ...
              <div className="row">
                ...
                <div className="col-xl-4 mil-mb-30">
                  <div className="mil-icon-box mil-with-bg mil-center mil-up">
                    ...
                    <p className="mil-text-s mil-soft mil-up">
                      From special offers to added security, every transaction
                      is not just a purchase, but an open door to a range.
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <li>
                      <div className="mil-up">
                        ...
                        <p className="mil-text-m mil-soft">
                          ...
                          account. If we detect activity from a new device or{" "}
                          <br />
                    ...
                    <li>
                      <div className="mil-up">
                        ...
                        <p className="mil-text-m mil-soft">
                          ...
                          <br />
                          case of unauthorized transactions or unusual
                          activities.
                        </p>
                      </div>
                    </li>
